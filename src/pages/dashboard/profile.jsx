...
const InstagramLogin = dynamic(
    () =>
        import('@amraneze/react-instagram-login').then(
            module => module.InstagramLogin
        ),
    {
        ssr: false,
    }
...
function ProfilePage() {
    ...
    const onInstagramLogin = async account => {
        if (!account) return;
        try {
                    ...
                    <div className="mx-auto max-w-[89%]">
                        <div className="flex flex-col lg:flex-row items-center">
                            ...
                            <div className="lg:ml-8 flex flex-col w-full">
                                <div className="flex flex-col lg:flex-row items-center justify-between pb-4 lg:pb-5 mt-4 lg:mt-0 lg:border-b lg:border-gray-50">
                                    <div className="flex flex-col space-y-2 pb-4 lg:pb-0 border-b border-solid border-gray-50 lg:border-none mb-4 lg:mb-0 w-full lg:w-fit">
                                    ...
                                    <InstagramLogin
                                        cssClass="text-white text-sm bg-black-400 rounded-md h-9 w-full lg:w-fit px-4 font-semibold"
                                        clientId="684477648739411"
                                        onSuccess={onInstagramLogin}
                                        onFailure={({ error_reason }) =>
                                            toast.error(error_reason)
                                        }>
